    ...
    public partial class MainWindow : Window
    {
        ...
        private void btnTransformadaFourier_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (transformada != null)
            {
                ...
                if (frecuenciaFundamental >= 350.00 && frecuenciaFundamental <= 450.00)
                {
                    lblFrecuenciaFundamentalNota.Text = "Rojo";
                }
                if (frecuenciaFundamental >= 750.00 && frecuenciaFundamental <= 850.00)
                {
                    lblFrecuenciaFundamentalNota.Text = "Verde";
                }
                if (frecuenciaFundamental >= 1150.00 && frecuenciaFundamental <= 1250.00)
                {
                    lblFrecuenciaFundamentalNota.Text = "Morado";
                }
                if (frecuenciaFundamental >= 1550.00 && frecuenciaFundamental <= 1650.00)
                {
                    lblFrecuenciaFundamentalNota.Text = "Azul";
                }
                if (frecuenciaFundamental >= 1950.00 && frecuenciaFundamental <= 2050.00)
                {
                    lblFrecuenciaFundamentalNota.Text = "Amarillo";
                }
